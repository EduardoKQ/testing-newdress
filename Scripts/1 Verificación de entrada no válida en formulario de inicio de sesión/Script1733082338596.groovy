...
WebUI.setText(findTestObject('Object Repository/Page_NEW DRESS/input_Usuario_ion-input'), 'OR 1=1 --')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_NEW DRESS/input_Contrasea_ion-input'), 'tzH6RvlfSTg=')
...
// Check for error response text
def errorMessage = WebUI.getText(findTestObject('Object Repository/Page_NEW DRESS/error_message'))
